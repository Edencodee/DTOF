...
/* ******************* spad 数据回传模式 *****************/
#define SPAD_MODE_1CH           (0x00)   //标准报点模式 
#define SPAD_MODE_2CH           (0x01)	 //双回波报点模式
#define SPAD_MODE_ENGN          (0x02)   //工程报点模式
#define SPAD_MODE_SELF_TEST     (0x03)   //自我测试模式
#define SPAD_MODE_VERSION       (0x04)   //软件版本模式
