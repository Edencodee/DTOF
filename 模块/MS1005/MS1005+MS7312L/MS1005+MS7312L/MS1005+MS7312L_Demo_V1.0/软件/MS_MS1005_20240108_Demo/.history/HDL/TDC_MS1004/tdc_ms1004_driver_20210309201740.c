...
res_value |= (res.RFEDGE1      : 1; //0 
res_value |= (res.RFEDGE2      : 1; //1 
res_value |= (res.RESERVED1    : 2; //2-
res_value |= (res.EN_INT       : 3; //4:
res_value |= (res.EN_SEL_TIMO  : 1; //7 
res_value |= (res.NEG_START    : 1; //8 
res_value |= (res.NEG_STOP1    : 1; //9 
res_value |= (res.NEG_STOP2    : 1; //10
res_value |= (res.RESERVED2    : 1; //11
res_value |= (res.NO_CAL_AUTO  : 1; //12
res_value |= (res.CALIBRATE    : 1; //13
res_value |= (res.SEL_TSTO2    : 2; //14
res_value |= (res.EN_FAST_INIT : 1; //16
res_value |= (res.EN_ERR_VAL   : 1; //17
res_value |= (res.DOUBLE_RES   : 1; //18
res_value |= (res.START_CLKHS  : 1; //19
res_value |= (res.DIV_CLKHS    : 2; //20
res_value |= (res.SEL_TIMO     : 2; //22
res_value |= (res.HITIN1       : 4; //24
res_value |= (res.HITIN2       : 4; //28               
}
