...
20
22
24REG_READ_BIT(res_value, 0 , 0 );
    config_res.RFEDGE2      = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 4 , 4 );
    config_res.EN_SEL_TIMO  = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 7 , 7 );
    config_res.NEG_START    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 8 , 8 );
    config_res.NEG_STOP1    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 9 , 9 );
    config_res.NEG_STOP2    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 10, 10);
    config_res.RESERVED2    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 11, 11);
    config_res.NO_CAL_AUTO  = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 12, 12);
    config_res.CALIBRATE    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 13, 13);
    config_res.SEL_TSTO2    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 14, 14);
    config_res.EN_FAST_INIT = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 16, 16);
    config_res.EN_ERR_VAL   = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 17, 17);
    config_res.DOUBLE_RES   = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 18, 18);
    config_res.START_CLKHS  = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 19, 19);
    config_res.DIV_CLKHS    = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 20, 20);
    config_res.SEL_TIMO     = 0 
1 
2 
4 
7 
...
20
22
24REG_READ_BIT(res_value, 22, 22);
    config_res.HITIN1       = 0 
1 
2 
4 
...
20
22
24REG_READ_BIT(res_value, 24, 24);
}0 
1 
2 
4 
