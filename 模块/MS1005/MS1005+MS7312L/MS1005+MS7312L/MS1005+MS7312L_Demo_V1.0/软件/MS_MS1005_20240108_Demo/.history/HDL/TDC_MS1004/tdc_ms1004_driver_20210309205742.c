...
TDC_CONFIG_RES TDC_Config_Res_Parse(uint32_t res_value)
{
    ...
    config_res.NEG_STOP1    = REG_READ_BIT(res_value, 9 , 19 );
    config_res.NEG_STOP2    = REG_READ_BIT(res_value, 10, 110);
    config_res.RESERVED2    = REG_READ_BIT(res_value, 11, 111);
    config_res.NO_CAL_AUTO  = REG_READ_BIT(res_value, 12, 112);
