...
TDC_CONFIG_RES TDC_Config_Res_Parse(uint32_t res_value)
{
    ...
    config_res.RFEDGE1      = REG_READ_BIT(res_value, m, n)( >> 0 )
    config_res.RFEDGE2      = REG_READ_BIT(res_value, m, n)( >> 1 )
    config_res.RESERVED1    = REG_READ_BIT(res_value, m, n)( >> 2 )
    config_res.EN_INT       = REG_READ_BIT(res_value, m, n)( >> 4 )
    config_res.EN_SEL_TIMO  = REG_READ_BIT(res_value, m, n)( >> 7 )
    config_res.NEG_START    = REG_READ_BIT(res_value, m, n)( >> 8 )
    config_res.NEG_STOP1    = REG_READ_BIT(res_value, m, n)( >> 9 )
    config_res.NEG_STOP2    = REG_READ_BIT(res_value, m, n)( >> 10)
    config_res.RESERVED2    = REG_READ_BIT(res_value, m, n)( >> 11)
    config_res.NO_CAL_AUTO  = REG_READ_BIT(res_value, m, n)( >> 12)
    config_res.CALIBRATE    = REG_READ_BIT(res_value, m, n)( >> 13)
    config_res.SEL_TSTO2    = REG_READ_BIT(res_value, m, n)( >> 14)
    config_res.EN_FAST_INIT = REG_READ_BIT(res_value, m, n)( >> 16)
    config_res.EN_ERR_VAL   = REG_READ_BIT(res_value, m, n)( >> 17)
    config_res.DOUBLE_RES   = REG_READ_BIT(res_value, m, n)( >> 18)
    config_res.START_CLKHS  = REG_READ_BIT(res_value, m, n)( >> 19)
    config_res.DIV_CLKHS    = REG_READ_BIT(res_value, m, n)( >> 20)
    config_res.SEL_TIMO     = REG_READ_BIT(res_value, m, n)( >> 22)
    config_res.HITIN1       = REG_READ_BIT(res_value, m, n)( >> 24)
}
