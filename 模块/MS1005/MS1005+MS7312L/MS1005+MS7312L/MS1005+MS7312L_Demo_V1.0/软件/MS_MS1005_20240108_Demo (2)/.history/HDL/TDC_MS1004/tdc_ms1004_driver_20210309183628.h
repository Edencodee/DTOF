...
typedef enum
{
    WRITE_CONFIG_RES = 0x80, //
    READ_STOP1_DATA = 0xB0,  //
    READ_STOP2_DATA = 0xC0,  //
    READ_CAL_DATA = 0xBB,    //
    READ_CONFIG_RES_LSB = 0xBC,
    READ_STAT_RES = 0xBD, //
    INIT_DEVICE = 0x70,
    RESET_DEVICE = 0x50,
    START_CAL_TDC = 0x04,
...
typedef enum
{
    RES1_0 = 0xB0, //STOP1 测量结guo0
    RES1_1 = 0xB1, //STOP1 测量结guo1
    RES1_2 = 0xB2, //STOP1 测量结guo2
    RES1_3 = 0xB3, //STOP1 测量结guo3
    RES1_4 = 0xB4, //STOP1 测量结guo4
    RES1_5 = 0xB5, //STOP1 测量结guo5
    RES1_6 = 0xB6, //STOP1 测量结guo6
    RES1_7 = 0xB7, //STOP1 测量结guo7
    RES1_8 = 0xB8, //STOP1 测量结guo8
    RES1_9 = 0xB9, //STOP1 测量结guo9
