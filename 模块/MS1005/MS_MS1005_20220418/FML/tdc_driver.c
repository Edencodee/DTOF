...
void Tdc_Register_Config(void)
{
    ...
    REG0 = 0x225A2460;// // dual channel  Single Accuracy Auto Calbration
...
//    printf("status = %0x\n", status);
    ...
    tdc_res.RES_0 = TDC_ReadWrite_Data24(0); //Stop1-start
    TDC_NSS_1;

    delay_us(1);
    TDC_NSS_0;
    TDC_ReadWrite_Data8(0xC0);
    tdc_res.RES_1 = TDC_ReadWrite_Data24(0); //stop2-start
    TDC_NSS_1;
		
    tdc_res.RES_1 = tdc_res.RES_1 - tdc_res.RES_0; //stop2-stop1=pulsewidth
