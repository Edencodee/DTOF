...
extern const RANGETypedef IntensityRange;
extern const RANGETypedef DistanceRange;
extern const Lidar_PointTypeDef invalid_point;
extern uint16_t Compensation[COMPENSATION_SIZE];
