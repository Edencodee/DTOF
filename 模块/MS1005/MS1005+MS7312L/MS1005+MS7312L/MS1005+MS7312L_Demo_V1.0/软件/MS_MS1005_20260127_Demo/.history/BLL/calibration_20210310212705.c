...
const RANGETypedef APDCalibration_IntensityRange  = {350 , 370};  //调整增益时
const RANGETypedef TIM_Pulse_Range  = {50 , 200};
/**
 * @brief 进入校正模式
 */
    ...
    for (int cnt = 0; cnt < 10; cnt++)
    {
        ...
        while(max_temp < min_temp + 10)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                printf("now_temp = %5.2f, max_temp = %5.2f, min_temp = %5.2f, dist = %d, itst = %d\n",
