...
typedef enum
{
    ...
    READ_STOP1_DATA1 = 0xB1,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA2 = 0xB2,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA3 = 0xB3,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA4 = 0xB4,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA5 = 0xB5,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA6 = 0xB6,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA7 = 0xB7,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA8 = 0xB8,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA9 = 0xB9,   //读取地址 STOP1 数据 0   读出 24bit
