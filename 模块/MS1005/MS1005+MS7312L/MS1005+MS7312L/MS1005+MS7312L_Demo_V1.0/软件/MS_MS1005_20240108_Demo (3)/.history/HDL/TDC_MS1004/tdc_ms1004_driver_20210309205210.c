...
TDC_CONFIG_RES TDC_Config_Res_Parse(uint32_t res_value)
{
    ...
    config_res.RFEDGE1      = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
140 , 0 );
    config_res.RFEDGE2      = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
141 , 1 );
    config_res.RESERVED1    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
142 , 2 );
    config_res.EN_INT       = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
144 , 4 );
    config_res.EN_SEL_TIMO  = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
147 , 7 );
    config_res.NEG_START    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
148 , 8 );
    config_res.NEG_STOP1    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
149 , 9 );
    config_res.NEG_STOP2    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1410, 10);
    config_res.RESERVED2    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1411, 11);
    config_res.NO_CAL_AUTO  = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1412, 12);
    config_res.CALIBRATE    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1413, 13);
    config_res.SEL_TSTO2    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1414, 14);
    config_res.EN_FAST_INIT = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1416, 16);
    config_res.EN_ERR_VAL   = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1417, 17);
    config_res.DOUBLE_RES   = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1418, 18);
    config_res.START_CLKHS  = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1419, 19);
    config_res.DIV_CLKHS    = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1420, 20);
    config_res.SEL_TIMO     = REG_READ_BIT(res_value, 11
11
12
13
11
...
14
1422, 22);
    config_res.HITIN1       = REG_READ_BIT(res_value, 11
11
12
13
11
