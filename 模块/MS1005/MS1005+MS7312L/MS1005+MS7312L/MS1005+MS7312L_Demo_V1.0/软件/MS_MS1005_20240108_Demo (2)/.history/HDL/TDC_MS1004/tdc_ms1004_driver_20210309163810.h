...
typedef struct
{
    ...
    uint32_t RESERVED : 2;    //2-3,必须设置位默认值
    uint32_t EN_INT : 3;      //3,INIT输出中断源选择
    uint32_t EN_SEL_TIMO : 1; //4,
    uint32_t NEG_START : 1;   //2,
    uint32_t NEG_STOP1 : 1;   //2,
    uint32_t NEG_STOP2 : 1;   //2,
}TDC_CONFIG_RES
