...
typedef enum
{
    ...
    READ_STOP2_DATA0 = 0xB0,   //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP2_DATA1 = 0xB1,   //读取地址 STOP1 数据 1   读出 24bit
    READ_STOP2_DATA2 = 0xB2,   //读取地址 STOP1 数据 2   读出 24bit
    READ_STOP2_DATA3 = 0xB3,   //读取地址 STOP1 数据 3   读出 24bit
    READ_STOP2_DATA4 = 0xB4,   //读取地址 STOP1 数据 4   读出 24bit
    READ_STOP2_DATA5 = 0xB5,   //读取地址 STOP1 数据 5   读出 24bit
    READ_STOP2_DATA6 = 0xB6,   //读取地址 STOP1 数据 6   读出 24bit
    READ_STOP2_DATA7 = 0xB7,   //读取地址 STOP1 数据 7   读出 24bit
    READ_STOP2_DATA8 = 0xB8,   //读取地址 STOP1 数据 8   读出 24bit
    READ_STOP2_DATA9 = 0xB9,   //读取地址 STOP1 数据 9   读出 24bit    
