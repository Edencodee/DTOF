...
TDC_CONFIG_RES TDC_Config_Res_Parse(uint32_t res_value)
{
    ...
    config_res.RFEDGE1      = (res_value)
    config_res.RFEDGE2      = (res_value)
    config_res.RESERVED1    = (res_value)
    config_res.EN_INT       = (res_value)
    config_res.EN_SEL_TIMO  = (res_value)
    config_res.NEG_START    = (res_value)
    config_res.NEG_STOP1    = (res_value)
    config_res.NEG_STOP2    = (res_value)
    config_res.RESERVED2    = (res_value)
    config_res.NO_CAL_AUTO  = (res_value)
    config_res.CALIBRATE    = (res_value)
    config_res.SEL_TSTO2    = (res_value)
    config_res.EN_FAST_INIT = (res_value)
    config_res.EN_ERR_VAL   = (res_value)
    config_res.DOUBLE_RES   = (res_value)
    config_res.START_CLKHS  = (res_value)
    config_res.DIV_CLKHS    = (res_value)
    config_res.SEL_TIMO     = (res_value)
    config_res.HITIN1       = (res_value)
}
