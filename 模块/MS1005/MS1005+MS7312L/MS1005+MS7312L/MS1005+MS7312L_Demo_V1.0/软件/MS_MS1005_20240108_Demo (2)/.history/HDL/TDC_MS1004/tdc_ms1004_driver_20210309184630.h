...
typedef enum
{
    ...
    READ_STOP1_DATA1 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA2 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA3 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA4 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA5 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA6 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA7 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA8 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
    READ_STOP1_DATA9 = 0xB0,    //读取地址 STOP1 数据 0   读出 24bit
