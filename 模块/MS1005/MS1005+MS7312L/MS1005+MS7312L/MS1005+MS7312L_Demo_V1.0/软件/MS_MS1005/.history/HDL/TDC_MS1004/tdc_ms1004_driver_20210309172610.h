...
typedef struct
{
    uint32_t STOP1_RESULT : 4;//STOP1 结果地址指针
    uint32_t RESERVED1 : 1; //4
    uint32_t STOP1_CNT : 4; //5:8
    uint32_t STOP2_CNT : 4; //9:12
    uint32_t TDC_OUT : 1; //13
    uint32_t TIMEOUT : 1; //14
    uint32_t RESERVED2 : 1; //15
    uint32_t STOP2_RESULT : 4;
    uint32_t RESERVED3 : 4; //20:23
    uint32_t RESERVED3 : 4; //24:31
}
